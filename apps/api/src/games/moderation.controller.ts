...
import { ReviewGameInput } from '@indieforge/contracts';
...
export class ModerationController {
  ...
  @Post(':id/approve')
  approve(@Param('id') gameId: string) {
    return this.moderation.approve(gameId);
  }
  ...
  reject(@Param('id') gameId: string, @Body() body: unknown) {
    ...
    return this.moderation.reject(gameId, input.data.reviewNote);
  }
}
