  ...
  return (
    <main className="create-game-page">
      ...
      <ol className="creation-steps" aria-label="Các bước sáng tạo">
        <li><strong>Bắt đầu với bản nháp</strong><p>Tạo một dự án trống trong Xưởng sáng tạo.</p></li>
      ...
      <section className="creation-start panel" aria-labelledby="creation-start-title">
        ...
        <p>Tạo một dự án trống, rồi đặt tên và xây dựng từng cảnh trong Xưởng sáng tạo.</p>
