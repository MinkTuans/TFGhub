# Hướng dẫn TFG Pixel Studio

Hướng dẫn công khai: `/huong-dan`. Nội dung này cũng có trong tác vụ **Hướng dẫn** của Studio.

## 1. Tạo trò chơi đầu tiên
...
## 2. Hiểu cảnh, đối tượng và hành vi
...
## 3. Nhập ảnh PNG và âm thanh WAV
...
```js
// Nội dung hàm; quyền SHOW_DIALOGUE; gắn cảnh đang chơi.
api.showDialogue("Xin chào! Gom đủ 5 đom đóm rồi đến hải đăng.");
```

## 5. Lưu, bản sao JSON và xung đột
...
## Bài thực hành kiểm tra

1. Tạo mẫu và chơi thắng; thử chạm gai ba lần để thấy thua rồi Chơi lại.
2. Di chuyển một cây, tăng tốc độ Linh, hoàn tác/làm lại và tải lại trang sau khi lưu.
3. Nhập PNG, đặt vào cảnh; nhập WAV và dùng PLAY_AUDIO hoặc script có quyền PLAY_AUDIO.
4. Nhập tệp JS thay lời chào, lưu và dựng lại. Thử sửa một lỗi cú pháp được chẩn đoán.
5. Xuất JSON; nhập lại trong dự án hiện tại và kiểm tra dữ liệu còn nguyên.
6. Dựng, chơi thử trên máy tính và điện thoại, hoàn thiện mô tả rồi gửi duyệt.

## Tài liệu liên quan

- [Kho kiến thức dự án](../README.md)
- [Luồng soạn thảo, xuất bản và tài nguyên](authoring-publishing-and-assets.md)
- [Kiến trúc Engine và Studio](../02-architecture/engine-and-studio.md)
